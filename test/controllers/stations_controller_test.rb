...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference("Station.count") do
      post stations_url, params: { station: { hipot_ips: @station.hipot_ips, ingersoll_ips: @station.ingersoll_ips, line_id: @station.line_id, model: @station.model, name: @station.name, operator_instructions: @station.operator_instructions } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { hipot_ips: @station.hipot_ips, ingersoll_ips: @station.ingersoll_ips, line_id: @station.line_id, model: @station.model, name: @station.name, operator_instructions: @station.operator_instructions } }
