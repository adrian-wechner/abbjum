...
class ChecklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist" do
    assert_difference("Checklist.count") do
      post checklists_url, params: { checklist: { line_id: @checklist.line_id, name: @checklist.name } }
    end
  ...
  test "should update checklist" do
    patch checklist_url(@checklist), params: { checklist: { line_id: @checklist.line_id, name: @checklist.name } }
