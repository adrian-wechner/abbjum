...
class ChecklistItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist_item" do
    assert_difference("ChecklistItem.count") do
      post checklist_items_url, params: { checklist_item: { checklist_id: @checklist_item.checklist_id, ident: @checklist_item.ident, itemtype: @checklist_item.itemtype, label: @checklist_item.label, ordernum: @checklist_item.ordernum, primaryanswers: @checklist_item.primaryanswers, primaryanswertype: @checklist_item.primaryanswertype, secondaryanswertype: @checklist_item.secondaryanswertype } }
    end
  ...
  test "should update checklist_item" do
    patch checklist_item_url(@checklist_item), params: { checklist_item: { checklist_id: @checklist_item.checklist_id, ident: @checklist_item.ident, itemtype: @checklist_item.itemtype, label: @checklist_item.label, ordernum: @checklist_item.ordernum, primaryanswers: @checklist_item.primaryanswers, primaryanswertype: @checklist_item.primaryanswertype, secondaryanswertype: @checklist_item.secondaryanswertype } }
